...
describe('Request', function () {
    ...
    describe('requestWithSource', function () {
        it('should set correct source', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request_1.requestWithSource().post(testHost + "/post", {})];
                    case 1:
                        res = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request_1.requestWithSource({
                                retry: 2,
                                retryFactor: 2,
                                retryMaxTime: 1000,
                                onRetry: onRetry,
    ...
    describe('postWithRetry', function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request_1.postWithRetry(testHost + "/post", fields, { headers: headers })];
                    case 1:
                        _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request_1.postWithRetry(testHost + "/post", fields)];
                    case 1:
                        _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request_1.postWithRetry(testHost + "/fail2", fields, {}, {
                                retry: 2,
                                retryFactor: 2,
                                retryMaxTime: 1000,
                                onRetry: onRetry,
        ...
        it('should reject on max retry count', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        expect.assertions(1);
                        return [4 /*yield*/, expect(request_1.postWithRetry(testHost + "/fail2", {}, {}, {
                                retry: 1,
                                retryFactor: 2,
                                retryMaxTime: 1000,
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        nock(testHost)
                            .post('/401')
                            .reply(401, {});
                        return [4 /*yield*/, expect(request_1.postWithRetry(testHost + "/401", {}, {}, {
                                retry: 1,
                                retryFactor: 2,
                                retryMaxTime: 1000,
                                onRetry: onRetry,
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(request_1.postWithRetry(testHost + "/fail3", {}, {}, {
                                retry: 3,
                                retryFactor: 2,
                                retryMaxTime: 1000,
                                onRetry: onRetry,
        ...
        it('should not retry on user cancel request', function () {
            ...
            return expect(request_1.postWithRetry(testHost + "/fail2", {}, {
